...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~92457XmR5db01e56bb95b98cabf17472403d', //your ssid to run bot
    HEROKU: {
    ...
    ERROR_MSG : toBool(process.env.ERROR_MSG || "true"),    AJOIN: toBool(process.env.AJOIN || 'false'),
    ...
    SUDO : process.env.SUDO || "263716024646",
